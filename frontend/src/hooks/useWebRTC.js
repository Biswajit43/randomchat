...
const ICE_SERVERS = [
  ...
  // Add your TURN server here for production — without it, calls fail
  // whenever either peer is behind a symmetric NAT (common on mobile/corporate
  // networks). See backend/.env.example for TURN_URL/USERNAME/CREDENTIAL.
  // { urls: import.meta.env.VITE_TURN_URL, username: "...", credential: "..." },
];
